// Random.Password.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
void PasswordTest(char password[], double& strength)
{
    ...
    if (strength < 2)
        cout << "es muy malo" << endl;
    else if ((strength >= 2) && (strength < 4))
        cout << "es no bueno" << endl;
    else if ((strength >= 4) && (strength < 6))
        cout << "es okay" << endl;
    else if ((strength >= 6) && (strength < 8))
        cout << "es pretty good" << endl;
    else if (strength >= 9)
